    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '专利类型', prop: 'type_name', sortable: true, width: '145', overflow: true },
          ...
          { type: 'text', label: '承办人', prop: 'person_in_charge_name', show: true, sortable: true, width: '118'},
