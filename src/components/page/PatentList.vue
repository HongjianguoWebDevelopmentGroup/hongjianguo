    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '代理人', width: '200', prop: 'agent', render_simple: 'name', is_import: true},
          ...
          { type: 'text', label: '负面评价?', prop: 'negative_flag', is_import: true, width: '105', show: true, render_simple: 'name',},
          { type: 'text', label: '负面评价理由', prop: 'negative_comment', is_import: true, width: '135', show: true,},
          ...
          { type: 'text', label: '部门全名', prop: 'branch', sortable: true, render:  (h,item)=>h('span', item.name), width: '142' },
          { type: 'text', label: '部门简称', prop: 'abbr', sortable: true, render_simple: 'abbr', width:'140'},
          ...
          { type: 'text', label: '发明人评分', prop: 'inventor_rank', is_import: true, render: this.rateRender, width: '200', show: false},
          ...
          { type: 'text', label: 'IPR首次评分', prop: 'first_ipr_rank', is_import: true, render: this.rateRender, width: '200', show: false},
          { type: 'text', label: 'IPR终稿评分', prop: 'final_ipr_rank', is_import: true, render: this.rateRender, width: '200', show: false},
