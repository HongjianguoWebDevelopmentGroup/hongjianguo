    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'array', label: '申请人', prop: 'applicants', is_import: true, render: _=>_.map(_=>_.name), width: '220' ,sortable : true,},
          { type: 'text', label: '申请号', prop: 'apn', width: '178',sortable : true, },
          { type: 'text', label: '标题', prop: 'title', is_import: true, width: '160',sortable : true,},
          ...
          { type: 'text', label: '权利获取方式', prop: 'right_source', width: '145',sortable : true, },
          ...
          { type: 'text', label: '公告日', prop: 'issue_date', is_import: true, width: '120',sortable : true, },
          { type: 'text', label: '公告号', prop: 'issue_number', is_import: true, width: '198',sortable : true, },
          ...
          { type: 'text', label: '代理机构案号', prop: 'agency_serial', width: '198',sortable : true, },
          { type: 'array', label: '产品名称', prop: 'products', sortable: true, is_import: true, render: _=>_.map(_=>_.name), width: '150' },
          { type: 'text', label: '事务所案号', prop: 'agenxy_serial', width: '168',sortable : true, },
          { type: 'text', label: '摘要', prop: 'abstract', width: '280', show: false, sortable : true,},
          { type: 'text', label: '完成时间', prop: 'create_time', width: '175',sortable : true, },
