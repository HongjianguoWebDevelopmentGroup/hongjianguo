    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '版本号', prop: 'version', width: '145' },
          { type: 'text', label: '权利获取方式', prop: 'right_source', width: '145' },
          { type: 'text', label: '开发完成日期', prop: 'develop_date', width: '145' },
          { type: 'text', label: '首次发表日期', prop: 'publish_date', width: '145' },
          { type: 'text', label: '公告日', prop: 'issue_date', is_import: true, width: '183' },
          { type: 'text', label: '公告号', prop: 'issue_number', is_import: true, width: '198' },
          { type: 'text', label: 'IPR', prop: 'ipr', render_simple: 'name', is_import: true, width: '140' },
          ...
          { type: 'text', label: '代理机构案号', prop: 'agency_serial', width: '198' },
          { type: 'array', label: '产品名称', prop: 'products', sortable: true, is_import: true, render: _=>_.map(_=>_.name), width: '150' },
          { type: 'text', label: '事务所案号', prop: 'agenxy_serial', width: '198' },
          { type: 'text', label: '摘要', prop: 'abstract', width: '280', show: false, },
          { type: 'text', label: '完成时间', prop: 'create_time', width: '175' },
