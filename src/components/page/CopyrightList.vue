    ...
    return {
      ...
      tableOption: {
        ...
        'columns': [
          ...
          { type: 'text', label: '版本号', prop: 'version', width: '173' },
          { type: 'text', label: '权利获取方式', prop: 'right_source', width: '173' },
          { type: 'text', label: '摘要', prop: 'abstract', width: '280' },
          { type: 'text', label: '完成时间', prop: 'create_time', width: '173' },
          { type: 'text', label: '开发完成日期', prop: 'develop_date', width: '173' },
          { type: 'text', label: '首次发表日期', prop: 'publish_date', width: '173' },
