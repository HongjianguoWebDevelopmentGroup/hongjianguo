...
<<<<<<< HEAD
    this.axiosGet({url, success, error, catchFunc});
    // this.axiosPost({url: '/api/login', success: success2, data: {username: 'hongjianguo', password: ''}});
=======
    // this.axiosGet({url, success, error, catchFunc});
...
>>>>>>> 42b6f879eedeeeb08a362c7cba7d67b83a888cdc
  },
  beforeCreate () {
