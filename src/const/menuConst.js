...
const trademarkMenu = [
	...
	{ 
		...
		icon: 'iconfont el-icon-my-trademark',
		children: [
			{ type: 'item', text: '中国[CN]', path: '/trademark/area/cn', icon: '' },
			{ type: 'item', text: '印度[IN]', path: '/trademark/area/in', icon: '' },
			{ type: 'item', text: '美国[US]', path: '/trademark/area/us', icon: '' },
			{ type: 'item', text: '香港[HK]', path: '/trademark/area/hk', icon: '' },
			{ type: 'item', text: '泰国[TH]', path: '/trademark/area/th', icon: '' },
			{ type: 'item', text: '日本[JP]', path: '/trademark/area/jp', icon: '' },
			{ type: 'item', text: '新加坡[SG]', path: '/trademark/area/sg', icon: '' },
			{ type: 'item', text: '欧盟[EP]', path: '/trademark/area/ep', icon: '' },
			{ type: 'item', text: '英国[GB]', path: '/trademark/area/gb', icon: '' },
			{ type: 'item', text: '越南[VN]', path: '/trademark/area/vn', icon: '' },
			{ type: 'item', text: '俄罗斯[RU]', path: '/trademark/area/ru', icon: '' },
			{ type: 'item', text: '印尼[ID]', path: '/trademark/area/id', icon: '' },
